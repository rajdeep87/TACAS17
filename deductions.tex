...
$\vars=\{y\}$. \rmcmt{A binary} octagon \rmcmt{element} relate at 
...
variables in the \rmcmt{constraint system}, a subdomain is essentially a 
subset of variables \rmcmt{how we are defining subdomain?} that guides the propagations in forward, 
...
propagations in tandem.  \rmcmt{wrong to say abstract deduction transformer that 
has lhs, rhs since since it also includes the live variables}. 

Given a constraint system and a domain, an updateWorklist function adds 
