...
$\bot$ and $\top$, \rmcmt{which forms a lattice}.  An abstract 
...
\rmcmt{Thus, the choice of a subdomain helps to fine-tune the deductions 
...
If $\abstransel{\subdomain}$ deduce $\bot$, then 
