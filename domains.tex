...
In this section, we define a notion of program analysis constraints, concrete domain and abstract domain. 
\Omit {
\subsection{Programs:}
%
...
\textbf{Program Analysis Constraints:}  A program $\mathcal{P}$ is represented as set of equations called, {\em program analysis constraints}.  The 
