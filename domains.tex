...
operations~\cite{sriram,GS07b,BJKS15}\rmcmt{like what operations?}. In our implementation we use
...
of the \rmcmt{template polyhedra ?} domain. $\true$ is $\top$ and $\false$ is $\bot$.
...
a normal form that is usually required for efficient \rmcmt{or precise?} 
