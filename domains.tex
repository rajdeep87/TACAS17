...
\textbf{Program Analysis Constraints:}  A common approach to analyse 
a program $\mathcal{P}$ is to represent $\mathcal{P}$ as set of 
equations called, {\em program analysis constraints}.  The 
