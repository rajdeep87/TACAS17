...
C Program, Control-flow Graph (CFG) and Abstract Conflict Graph \pscmt{val $\rightarrow$ v; better rename $I$ to $n_0$ (also in the text); arrow from $n_2$ to $n_4$ on the rhs}}
\end{figure}
