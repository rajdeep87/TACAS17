...
C Program, Control-flow Graph (CFG) and Abstract Conflict Graph \pscmt{I do not understand the arrow from n2 to n3 on the right hand side}}
\end{figure}
...
Hence, ACDCL makes a decision $c:=[1,1]$ to refine the analysis. \pscmt{Do we want to use the product domain right away to be consistent?}  
...
\pscmt{clearly say that everything that follows is for finite
  unwindings of programs}
