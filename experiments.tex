...
inside 2LS verification tool~\cite{}.  The abstract domains used for 
...
generated using v2c~\cite{tacas16}, (c) controller code generated 
...
our tool with a state-of-the-art bounded model checker CBMC~\cite{cbmc} 
and a commercial abstract interpretation tool, Astr{\'e}e.  CBMC uses 
MiniSAT solver in the backend.  Astr\{'e}e was configured with interval 
