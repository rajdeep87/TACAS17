...
visualization of different decision heuristics in ACDCL.  We observe that 
the ordered heuristic outperforms other heuristics due to its ability to 
prioritize decisions on meet irreducibles that appear in conditional 
branches.  For straight-line code and most of the bit-vector regression 
suite, random heuristics performs the best.  
