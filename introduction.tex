...
Clause learning SAT solvers require a precise complementation property 
of the partial assignments domain.  However, standard static analysis 
based on abstract interpretation do not require complementation operator.   
In this paper, we implement our own template-based numerical abstract 
domains that precisely complements minimum complementable elements in 
the abstract domain.  
