...
For example, let $C = \langle x+z \geq 10,  w \geq 0 \rangle$ 
be a conflicting element that does not satisfy $\varphi$ and let $a= \langle x+y \geq 2, y+z \geq 5,
x+z \leq 15, w \geq 1, w \leq 1 \rangle$.  Applying the rule (3) of $AUnit_C$, we get a 
...
the first rule, since $a \sqsubseteq C$.  Now, let $a' = \langle x \geq 3, x \leq 4 \rangle$, 
