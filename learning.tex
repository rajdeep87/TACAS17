...
A learnt clause $\mathcal{L}$ is obtained by negating the reason for conflict.   
\rmcmt{shall we call learnt clause or learnt transformer ?}
%
\begin{figure}
